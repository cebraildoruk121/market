...
let sutUrunleri=["100uc","50","1000uc","250","10000uc","520"];
let gidaUrunleri=["100vp","75","1000vp","210","10000vp","620"];
let temizlikUrunleri=["100za","80","1000za","310","10000za","850"];
...
function koduEkle(){
    ...
    if(girilenKod == kod)
    {
        if(toplamTutar>=50)
        {
            ...
            document.getElementById("sepetTutar").innerHTML=toplamTutar+" TL";
            document.getElementById("sonuc").innerHTML="KOD uygulandı.";
